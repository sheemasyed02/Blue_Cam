        ...
        <div className={cn(
          ...
          <div className={cn(
            ...
            <div className="relative">
              <div className={cn(
                "bg-gradient-to-br from-serelune-400 to-blush-400 rounded-2xl flex items-center justify-center shadow-glow",
                // Mobile: Smaller logo
              ...
              <div className={cn(
                "absolute -top-1 -right-1 bg-gradient-to-r from-blush-400 to-serelune-400 rounded-full animate-sparkle",
                // Mobile: Smaller sparkle
